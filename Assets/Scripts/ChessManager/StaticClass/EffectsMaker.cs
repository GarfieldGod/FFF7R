...
public class EffectsMaker {
    ...
    private List<List<int>> effectStatusBase_ = GlobalScope.DeepCopy2DList(GlobalScope.EmptyStandard2DList);
    private List<List<int>> effectStatusEnhanced_ = GlobalScope.DeepCopy2DList(GlobalScope.EmptyStandard2DList);
    ...
    public List<List<int>> ComposeCardEffectsMap() {
        List<List<int>> effectEnhancedFinal = GlobalScope.Compose2DList(effectStatusEnhanced_, CalculateEnhancedEffectsList());
        return GlobalScope.Compose2DList(effectEnhancedFinal, effectStatusBase_);
    }
    public List<List<int>> CalculateEnhancedEffectsList() {
        List<List<int>> result = GlobalScope.DeepCopy2DList(GlobalScope.EmptyStandard2DList);
    ...
    private List<List<int>> UsePosStatus(){
        List<List<int>> result = GlobalScope.DeepCopy2DList(posStatus_);
    ...
    private List<List<int>> UseEffectStatusBase(){
        List<List<int>> result = GlobalScope.DeepCopy2DList(effectStatusBase_);
        if(inputerType_ == InputerType.RIVAL) {
    ...
    private List<List<int>> UseEffectStatusEnhanced(){
        List<List<int>> result = GlobalScope.DeepCopy2DList(effectStatusEnhanced_);
        if(inputerType_ == InputerType.RIVAL) {
            Rival.GetChessCardStatusInRivalView(result);
        }
        return result;
...
static class PosEffect {
    public static List<List<int>> DoPosEffect(Int2D chessGridPos, List<List<int>> posEffects, List<List<int>> chessGridPosEffectStatus) {
        List<List<int>> chessGridStatusTemp = GlobalScope.DeepCopy2DList(chessGridPosEffectStatus);
...
static class CardEffect {
    public static List<List<int>> DoCardEffect(ChessInputParm parms) {
        ...
        return DoCardEffect(parms.chessInputParms.pos, property, parms.chessPadInfo);
    }
    public static List<List<int>> DoCardEffect(Int2D chessGridPos, ChessProperty property, ChessPadInfo chessPadInfo) {
        ...
        if(cardEffects.Item2 == CardEffectsType.ON_PLAYED) {
            ...
            propertyTemp.TurnToOnPositionEffectNegativeTask();
    ...
    public static List<List<int>> ParseCardEffect(Int2D chessGridPos, ChessProperty property, List<List<int>> effectsMap, List<List<int>> posMap) {
        List<List<int>> chessGridStatusTemp = GlobalScope.DeepCopy2DList(effectsMap);
        Tuple<CardEffectsScope, CardEffectsType, List<List<int>>> cardEffects = property.CardEffects;
        if(cardEffects == null || cardEffects.Item3 == null || cardEffects.Item3.Count == 0) {
            return chessGridStatusTemp;
        }
